...
$menu = "
	...
	<ul>
		...
		<li class='dropdown'>
			<a href='#' title='$c[key]' class='dropbtn'><i class='fa fa-key fa-lg' title='$c[key]'></i></a>
			<div class='dropdown-content'>
				<a href='".$home.$lang.'/'.'signin'."'>$c[signin]</a>
				<a href='".$home.$lang.'/'.'signup'."'>$c[signup]</a>
				<a href='".$home.$lang.'/'.'forgot'."'>$c[forgot]</a>
			</div>
		</li>
		<li class='dropdown'>
